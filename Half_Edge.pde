class Mesh{
  ...
  void initMesh(){    
    ...
    //set faces first half edge
    f1.edge = he[1];
    f2.edge = he[2];
    
    //set half edges neighbourhood
    he[1].next = he[5]; he[1].prev = he[4]; he[1].twin = null; he[1].op[0] = p[4];
    he[2].next = he[3]; he[2].prev = he[6]; he[2].twin = null; he[2].op[0] = p[4];
    he[3].next = he[6]; he[3].prev = he[2]; he[3].twin = null; he[3].op[0] = p[2];
    he[4].next = he[1]; he[4].prev = he[5]; he[4].twin = null; he[4].op[0] = p[2];
    he[5].next = he[4]; he[5].prev = he[1]; he[5].twin = he[6]; he[5].op[0] = p[1]; he[5].op[1] = p[3];
    he[6].next = he[2]; he[6].prev = he[3]; he[6].twin = he[5]; he[6].op[0] = p[3]; he[6].op[1] = p[1]; 
  ...
  void addParticle(Particle np){
    ...
    he[1].next = he[2]; he[1].prev = ohe[1]; he[1].twin = he[4]; he[1].op[0] = p[1]; he[1].op[1] = p[3];
    he[2].next = ohe[1]; he[2].prev = he[1]; he[2].twin = he[5]; he[2].op[0] = p[2]; he[2].op[1] = p[3];
    he[3].next = he[4]; he[3].prev = ohe[2]; he[3].twin = he[6]; he[3].op[0] = p[2]; he[3].op[1] = p[1];
    he[4].next = ohe[2]; he[4].prev = he[3]; he[4].twin = he[1]; he[4].op[0] = p[3]; he[4].op[1] = p[1];
    he[5].next = he[6]; he[5].prev = ohe[3]; he[5].twin = he[2]; he[5].op[0] = p[3]; he[5].op[1] = p[2];
    he[6].next = ohe[3]; he[6].prev = he[5]; he[6].twin = he[3]; he[6].op[0] = p[1]; he[6].op[1] = p[2];
    ...
    if(ohe[1].op[0].equals(p[3]))ohe[1].op[0] = np;
    else if(ohe[1].op[1].equals(p[3]))ohe[1].op[1] = np;
    else if(ohe[1].op[0]==null)ohe[1].op[0] = np;
    ohe[2].next = he[3]; ohe[2].prev = he[4];
    if(ohe[2].op[0].equals(p[1]))ohe[2].op[0] = np;
    else if(ohe[2].op[1].equals(p[1]))ohe[2].op[1] = np;
    else if(ohe[2].op[0].equals(null))ohe[2].op[0] = np;
    ohe[3].next = he[5]; ohe[3].prev = he[6];
    if(ohe[3].op[0].equals(p[2]))ohe[3].op[0] = np;
    else if(ohe[3].op[1].equals(p[2]))ohe[3].op[1] = np;
    else if(ohe[3].op[0].equals(null))ohe[3].op[0] = np;
...
class Half_Edge{
  ...
  void flip(){
    if(this.twin==null) return; //not flip possible
    Half_Edge he = this;
    
    //find particles
    Particle p1 = he.ed.a;
    Particle p2 = he.next.ed.a;
    Particle p3 = he.next.next.ed.a;
    Particle p4 = he.twin.next.next.ed.a;
    
    //old half edges
    Half_Edge s1 = he.next;
    Half_Edge s2 = s1.next;
    Half_Edge s3 = he.twin.next;
    Half_Edge s4 = s3.next;
    
    //new edges
    Edge nhed = new Edge(p4,p3);
    Edge nthed = new Edge(p4,p3);
    
    //update faces first face edge
    he.face.edge = he;
    he.twin.face.edge = he.twin;
    
    //update half edge edges
    he.ed = nhed;
    he.twin.ed = nthed;
    
    //update neighbourhouds
    s1.next = he.twin; s1.prev = s4;
    s2.next = s3; s2.prev = he;
    s3.next = he.twin; s3.prev = s2;
    s4.next = s1; s4.prev = he.twin;
    he.next = s2; he.prev = s3;
    he.twin.next = s4; he.twin.prev = s1;
